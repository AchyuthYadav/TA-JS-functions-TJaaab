...
// - Execute the function and store the return value in a variable.
    const returnValue = substractOne(18);
...
// - Execute the function and store the return value in a variable
    const returnValue = sum(3);

// - What is the typeof returnValue
    //typeof of returnValue is number
...
// - Write a Function Declaration
    function isGreater(numX, numY){
      if(numX >= numY){
        return(`enter number is true`);
      }else(numX <= numY)
        return (`enter number is false`)  
      }
...
// - Write a Function Expression
    const isGreater = function(numX, numY){
      return numX >= numY;
    }

// - Write an Arrow Function without curly brackets(if possible)
    const isGreater = (numX, numY) => numX >= numY;

// - Write an Arrow Function with curly brackets
    const isGreater = (numX, numY) => {
      return numX >= numY;
    }
